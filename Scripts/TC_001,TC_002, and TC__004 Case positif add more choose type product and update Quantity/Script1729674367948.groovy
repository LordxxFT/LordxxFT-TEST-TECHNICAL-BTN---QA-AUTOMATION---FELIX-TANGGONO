...
WebUI.click(findTestObject('Object Repository/Page_Products  Automation Practice Site/a_HTML product type'))
...
WebUI.setText(findTestObject('Page_Basket  Automation Practice Site/input__cart(HTML5 Form)'), Quantity)
