...
WebUI.dragAndDropToObject(findTestObject('Page_Products  Automation Practice Site/span_Filter by price_ui-slider-handle ui-corner-all ui-state-default ui-state-focus ui-state-hover'), 
    findTestObject('Page_Products  Automation Practice Site/span_Filter by price_ui-slider-handle ui-corner-all ui-state-default ui-state-hover'), 
...
WebUI.click(findTestObject('Page_Products  Automation Practice Site/a_Add to basket'))
...
WebUI.click(findTestObject('Page_Basket  Automation Practice Site/input_Coupon_coupon_code'))

//WebUI.setText(findTestObject('Page_Basket  Automation Practice Site/input__cart(Functional Programming ni JS)'), Quantity)
//
//WebUI.click(findTestObject('Object Repository/Page_Basket  Automation Practice Site/input_Coupon_update_cart'))
WebUI.setText(findTestObject('Page_Basket  Automation Practice Site/input_Coupon_coupon_code'), Coupon)

WebUI.click(findTestObject('Object Repository/Page_Basket  Automation Practice Site/input_Coupon_apply_coupon'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Page_Basket  Automation Practice Site/a_Proceed to Checkout'))
...
WebUI.click(findTestObject('Page_Checkout  Automation Practice Site/input_PayPal Express Checkout_woocommerce_checkout_place_order2'))
